...
public class mountainController {
    private Map<Integer, mountain> mountains = new HashMap<>();
    ...
    @GetMapping("/test")
    public String test() {
        return "Mountain app is up and running!";
    }
    ...
    public List<PathListEntry<Integer>> mountain() {
    ...
    public mountain getMountain(@PathVariable Integer id) {
        return this.mountains.get(id);
    }

    @PostMapping("/services/mountain")
    public void createMountain(@RequestBody mountain mountains) {
    ...
    public void updateMountain(@PathVariable Integer id, @RequestBody mountain mountains) {   
        mountains.setId(id);
        this.mountains.put(id, mountains);
    }

    @DeleteMapping("/services/mountain/{id}")
    public mountain deleteMountain(@PathVariable Integer id) {
